...
const route = useRoute()
const userInputPath = `您输入的路径: ${route.params.pathMatch} 不存在, 请输入正确的路径`
const toIndex = () => {
  router.push('/index')
}
</script>
...
![image-20230813165206895](https://images.weserv.nl/?url=https://article.biliimg.com/bfs/article/5964980197bca31c4fb5251d2bbd61e1edd73278.png)
